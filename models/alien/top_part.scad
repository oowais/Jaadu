...
module head(whole=false) {
    union() {
        ...
        if (false == whole) {
            difference() {
                union() {
                    translate([1, 0.7, 0]) top_pattern();
                    translate([14, 0.7, 0]) top_pattern();
                }
        ...
        difference() {
            translate([0, -5, 0]) cube([20, 15, 0.2]);
            translate([0, 10, -0.1]) rotate([0, 0, 180+33.86]) cube([20, 20, 0.4]);
            translate([0, -10, -0.1]) cube([20, 10, 0.4]);
            translate([20, 10, -0.1]) rotate([0, 0, -123.86])  cube([20, 20, 0.4]);
...
$fn=300;
//scale([10, 10, 10]) face();
//scale([10, 10, 10]) head(whole=false);
//scale([10, 10, 10]) head();
